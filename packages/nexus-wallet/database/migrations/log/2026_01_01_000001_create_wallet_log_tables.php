...
return new class extends Migration
{
    ...
    {
        // ========================================
        // log_change_trx_wallet: 通貨変更ログ
        // ========================================
        Schema::create('log_change_trx_wallet', function (Blueprint $table) {
        ...
        // ========================================
        // log_change_trx_wallet_balance: 通貨残高変更ログ
        // ========================================
        Schema::create('log_change_trx_wallet_balance', function (Blueprint $table) {
            $table->id()->comment('ログID');
            $table->unsignedBigInteger('sys_player_id')->comment('プレイヤーID');
    ...
    {
        Schema::dropIfExists('log_change_trx_wallet_balance');
        Schema::dropIfExists('log_change_trx_wallet');
    }
};
