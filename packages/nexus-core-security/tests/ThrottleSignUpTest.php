...
class ThrottleSignUpTest extends TestCase
{
    ...
    public function testAllowsRequestWithinIpLimit()
    {
        $ip = '192.168.1.1';
        $ipKey = "signup_rate_limit:ip:{$ip}";
        
        Config::shouldReceive('get')->with('security.throttle_signup.max_attempts_per_ip', 10)->andReturn(10);
        Config::shouldReceive('get')->with('security.throttle_signup.max_attempts_per_device', 3)->andReturn(3);
        Config::shouldReceive('get')->with('security.throttle_signup.rate_limit_window', 3600)->andReturn(3600);
    ...
    public function testBlocksRequestWhenIpLimitExceeded()
    {
        $ip = '192.168.1.2';
        $ipKey = "signup_rate_limit:ip:{$ip}";
    ...
    public function testBlocksRequestWhenDeviceLimitExceeded()
    {
        $ip = '192.168.1.3';
    ...
    public function testIncrementsCountersForBothIpAndDevice()
    {
        $ip = '192.168.1.4';
    ...
    public function testWorksWithoutDeviceId()
    {
        $ip = '192.168.1.5';
        $ipKey = "signup_rate_limit:ip:{$ip}";
