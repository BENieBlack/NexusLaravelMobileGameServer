    ...
    */
    ...
    'connections' => [
        ...
        'admin' => [
            ...
            'database' => env('DB_DATABASE', 'arche-local-adm'),
        ...
        'tool' => [
            ...
            'database' => env('DB_TOOL_DATABASE', 'arche-local-tol'),
            'username' => env('DB_TOOL_USERNAME', 'root'),
            'password' => env('DB_TOOL_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => env('DB_CHARSET', 'utf8mb4'),
            'collation' => env('DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
        ...
        'log' => [
            ...
            'database' => env('DB_LOG_DATABASE', 'arche-local-log'),
