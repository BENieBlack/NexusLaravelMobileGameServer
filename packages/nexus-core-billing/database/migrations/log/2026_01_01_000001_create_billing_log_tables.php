...
return new class extends Migration
{
    ...
    {
        // ========================================
        // log_change_trx_in_app_purchase: 課金購入履歴変更ログ
        // ========================================
        Schema::create('log_change_trx_in_app_purchase', function (Blueprint $table) {
        ...
        // ========================================
        // log_change_trx_in_app_purchase_effect: 課金効果変更ログ
        // ========================================
        Schema::create('log_change_trx_in_app_purchase_effect', function (Blueprint $table) {
            $table->id()->comment('ログID');
            $table->unsignedBigInteger('sys_player_id')->comment('プレイヤーID');
        ...
        // ========================================
        // log_change_trx_diamond: ダイヤモンド変更ログ
        // ========================================
        Schema::create('log_change_trx_diamond', function (Blueprint $table) {
            $table->id()->comment('ログID');
            $table->unsignedBigInteger('sys_player_id')->comment('プレイヤーID');
        ...
        // ========================================
        // log_change_trx_diamond_balance: ダイヤモンド残高変更ログ
        // ========================================
        Schema::create('log_change_trx_diamond_balance', function (Blueprint $table) {
            $table->id()->comment('ログID');
            $table->unsignedBigInteger('sys_player_id')->comment('プレイヤーID');
    ...
    {
        Schema::dropIfExists('log_change_trx_diamond_balance');
        Schema::dropIfExists('log_change_trx_diamond');
        Schema::dropIfExists('log_change_trx_in_app_purchase_effect');
        Schema::dropIfExists('log_change_trx_in_app_purchase');
    }
};
