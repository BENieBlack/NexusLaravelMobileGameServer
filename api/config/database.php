...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'trx2' => [
            'driver' => 'mysql',
            'host' => env('DB_TRX2_HOST', 'db-trx2'),
            'port' => env('DB_TRX2_PORT', '3306'),
            'database' => env('DB_TRX2_DATABASE') ?: env('APP_NAME', 'laravel') . '-' . env('APP_ENV', 'local') . '-trx2',
            'username' => env('DB_TRX2_USERNAME', 'root'),
            'password' => env('DB_TRX2_PASSWORD', 'root'),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'strict' => true,
