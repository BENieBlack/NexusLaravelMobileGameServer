...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('log_action_login_bonus_receive')) {
            return;
        }

        if (Schema::hasTable('log_trx_login_bonus_history')) {
            Schema::rename('log_trx_login_bonus_history', 'log_action_login_bonus_receive_legacy');
        }

        Schema::create('log_action_login_bonus_receive', function (Blueprint $table): void {
            $table->id();
