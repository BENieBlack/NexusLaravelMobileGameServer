...
{
    public function test_build_relative_update_with_positive_change()
    {
    ...
    public function test_build_relative_update_with_negative_change()
    {
        $builder = new UpdateQueryBuilder;
    ...
    public function test_build_relative_update_with_zero_change()
    {
        $builder = new UpdateQueryBuilder;
    ...
    public function test_build_relative_update_with_multiple_columns()
    {
        $builder = new UpdateQueryBuilder;
    ...
    public function test_build_relative_update_with_multiple_where_conditions()
    {
        $builder = new UpdateQueryBuilder;
    ...
    public function test_build_relative_update_with_no_relative_changes()
    {
        $builder = new UpdateQueryBuilder;
    ...
    public function test_build_relative_update_generates_correct_sql_structure()
    {
        $builder = new UpdateQueryBuilder;
