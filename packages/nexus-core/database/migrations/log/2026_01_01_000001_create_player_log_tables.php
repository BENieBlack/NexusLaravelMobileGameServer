...
return new class extends Migration
{
    ...
    {
        // ========================================
        // log_change_trx_player: プレイヤーアカウント変更ログ
        // ========================================
        Schema::create('log_change_trx_player', function (Blueprint $table) {
        ...
        // ========================================
        // log_change_trx_player_sns: SNS連携変更ログ
        // ========================================
        Schema::create('log_change_trx_player_sns', function (Blueprint $table) {
            $table->id()->comment('ログID');
            $table->unsignedBigInteger('sys_player_id')->comment('プレイヤーID');
            $table->enum('operation_type', ['insert', 'update', 'delete'])->comment('操作タイプ');
    ...
    {
        Schema::dropIfExists('log_change_trx_player_sns');
        Schema::dropIfExists('log_change_trx_player');
    }
};
