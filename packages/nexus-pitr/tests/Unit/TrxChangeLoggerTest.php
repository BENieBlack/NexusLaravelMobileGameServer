...
class TrxChangeLoggerTest extends TestCase
{
    ...
    #[Test]
    public function log_batch_does_nothing_when_empty_array(): void
    {
    ...
    #[Test]
    public function log_batch_groups_by_log_connection_and_inserts(): void
    {
        // Arrange
        $dto1 = new ChangeLog(
    ...
    #[Test]
    public function log_batch_handles_multiple_shards(): void
    {
        // Arrange
        $dto1 = new ChangeLog(
            uniqueRequestId: 'req-001',
    ...
    #[Test]
    public function log_single_record_calls_log_batch(): void
    {
        // Arrange
        $dto = new ChangeLog(
            uniqueRequestId: 'req-001',
    ...
    #[Test]
    public function log_batch_handles_null_data_properly(): void
    {
        // Arrange
        $dto = new ChangeLog(
            uniqueRequestId: 'req-001',
